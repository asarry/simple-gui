...
void test_line(ei_surface_t surface, ei_rect_t* clipper)
{
	...
	pts[0].point.x = 200; pts[0].point.y = 200; pts[0].next = &pts[1];
        pts[1].point.x = 200; pts[1].point.y = 400; pts[1].next = &pts[2];
        pts[2].point.x = 400; pts[2].point.y = 200; pts[2].next = &pts[3];
        pts[3].point.x = 400; pts[3].point.y = 400; pts[3].next = &pts[4];
        pts[4].point.x = 200; pts[4].point.y = 200; pts[4].next = NULL;
